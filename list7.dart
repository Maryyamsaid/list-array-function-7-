...
main() {
  ...
  // final numbers = List<int>.filled(5, 0);
  var total;
  final numbers1 = <int>[31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
  ...
  for (int x = 0; x < a; x++) {
    ...
    numbers1[a] = int.tryParse(dayspermonth!) ?? 0;
  ...
  int size = 6;
  //int j;
  var number1 = List<int>.filled(5, 0);
  var square = List<int>.filled(5, 0);
  var cube = List<int>.filled(5, 0);
  var sum1 = List<int>.filled(5, 0);
  for (int i = 0; i < size; i++) {
    number[i] = i;
    square[i] = i * i;
    cube[i] = i * i * i;
    sum1[i] = number1[i] + square[i] + cube[i];
  }
  var total1 = 0;
  print(number);
